...
Gerencia a viewport do jogo: zoom-to-cursor via scroll do mouse, pan via botão direito/meio, centralização suave em objetos e ajuste automático para mostrar o sistema inteiro.

# Orbital Physics Spec

## Purpose

Define o modelo de física orbital elíptica usado servidor e cliente: fórmula de posição, tratamento de corpos estáticos, fator de aceleração temporal e extrapolação local no cliente para animação suave.

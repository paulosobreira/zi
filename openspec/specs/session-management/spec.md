...
Define o ciclo de vida de sessões de jogador: geração e persistência de `sessionId` em localStorage, mapeamento servidor, reconexão automática, logoff e overlay de login.

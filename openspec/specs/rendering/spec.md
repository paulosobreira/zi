...
Define o pipeline de renderização PixiJS 7: camadas, representação visual dos corpos, partículas de cinturões com 3 modos de zoom, anéis de Saturno e nameplates em screen space.
